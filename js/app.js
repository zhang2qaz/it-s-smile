...
const PRODUCTS = [
  {
    ...
    badge: 'hot',
    color: 'lavender',
    description: '专为羊绒、羊毛、真丝等娇贵衣物研制。植萃洁净因子深入纤维去污，蛋白酶靶向瓦解血渍、奶渍等蛋白类污渍。中性配方pH≈7，温和不伤手。',
    features: [
      '深入洁净 - 植萃洁净因子深入纤维去污',
      '护色防缩 - 固色因子锁住色彩，不易褪色',
      '柔软蓬松 - 纤维柔顺因子减少摩擦，不易起球',
      '温和不伤手 - 中性配方pH≈7，贴近人体肌肤酸碱度'
    ],
    ingredients: ['天然茶籽提取物', '椰油精粹', '纤维柔顺因子', '固色因子'],
    specs: '255mL (8.6 fl oz)',
    slogan: 'Explore the cleaning power of nature',
    painPoints: ['发硬变形', '缩水起球', '褪色串色', '汗渍泛黄'],
    scent: { top: '柑橘', mid: '玫瑰', base: '琥珀' },
    certifications: ['防缩水', '防起球', '无磷', '无荧光增白剂'],
    usage: '手洗：将适量洗衣液倒入水中搅匀，放入衣物浸泡3-5分钟，轻轻揉捏挤压出水分，用清水漂洗干净即可。机洗：建议选择轻柔模式或羊毛洗模式。',
    scenes: ['羊毛衫', '羊绒大衣', '真丝裙', '羽绒服']
  },
  {
    id: 2,
    name: '妙可净内衣洗衣液',
    ...
    badge: 'hot',
    color: 'lemon',
    description: '专为内衣裤、贴身衣物研制。植萃洁净因子深入纤维去污，蛋白酶靶向瓦解血渍、奶渍等蛋白类污渍。经权威检测，99.9%抑菌，99%除螨。',
    features: [
      '深入去渍 - 植萃洁净因子深入纤维去污',
      '抑菌除螨 - 99.9%抑菌率，99%除螨率',
      '柔软亲肤 - 温和配方呵护贴身衣物',
      '温和不伤手 - 中性配方pH≈7，贴近人体肌肤酸碱度'
    ],
    ingredients: ['天然茶籽提取物', '椰油精粹', '抑菌因子', '除螨因子'],
    specs: '255mL (8.6 fl oz)',
    slogan: 'Explore the cleaning power of nature',
    painPoints: ['血渍难洗', '发黄发硬', '细菌滋生', '易损变形'],
    scent: { top: '柑橘', mid: '玫瑰', base: '琥珀' },
    certifications: ['99.9%抑菌', '99%除螨', '无磷', '无荧光增白剂'],
    usage: '手洗：将适量洗衣液倒入水中搅匀，放入衣物浸泡3-5分钟，轻轻揉洗，用清水漂洗干净即可。',
    scenes: ['内衣裤', '睡衣', '宝宝衣物', '毛巾']
  }
];
